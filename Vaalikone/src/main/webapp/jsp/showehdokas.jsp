...
<body>
	...
	<h2>
		<u>2022 Meemi vaali ehdokkaat</u>
	</h2>
	<h4>
		Vaaliehdokkaat ovat tarkkaan ammattilaisten avulla valittuja
		yksilöitä,<br> joilla kaikkilla on ainutlaatuinen persoona ja
		ulkonäkö.<br> Tällä sivulla voit katsoa ehdokkaiden tietoja.
	...
	<div class="float-container">
			...
			<%
				...
				for (int i = 0; EhdokkaatList != null && i < EhdokkaatList.size(); i++) {
					...
					out.println(
							...
							"<table>" + "<th>" + "<h3>" + f.getEhdokas_num() + ". " + f.getEtunimi() + "</h3>" + "</th>"
									+ "</table>" +

									"<table>" + "<tr>" + "<th>" + "Kotipaikkakunta: " + "</th>" + "<td>"
									+ f.getKotipaikkakunta() + "</td>" + "</tr>" +

									"<tr>" + "<th>" + "Ikä: " + "</th>" + "<td>" + f.getIka() + "</td>" + "</tr>" +

									"<tr>" + "<th>" + "Ammatti: " + "</th>" + "<td>" + f.getAmmatti() + "</td>" + "</tr>" +

									"<tr>" + "<th>" + "Kommentti: " + "</th>" + "<td>" + f.getKommentti() + "</td>"
									+ "</tr>" +
		...
		<!-- tähän loppuu kaikki jotka menee vasemalle -->
		...
		<div class="float-child">
			...
			<%
				...
				for (int i = 0; KysymysList != null && i < KysymysList.size(); i++) {
					...
					out.println("<table>" + "<tr>" + "Kysymys numero: " + k.getId() + " " + k.getKysymys() + "<br>" +
